...
define(['View', 'Site', 'Formatter', 'util', 'underscore', 'model/ObservableArray', 'model/ObservableValue'], function(View, Site, Formatter, util, _, ObservableArray, ObservableValue) {
  ...
  return CollaborateView = (function(_super) {
    ...
    CollaborateView.prototype.doInit = function(obj) {
      var getObject, id, nameMap, object, objectData, objectText, table, userId, _nameMap, _next, _ref, _ref1;
      if (!this.agora.user) {
        return;
      }
      getObject = (function(_this) {
        return function(modelName, id) {
          ...
          id = (_ref = (_ref1 = _this.agora.db.globalToLocalMapping) != null ? (_ref2 = _ref1[model._table.name]) != null ? _ref2[id] : void 0 : void 0) != null ? _ref : id;
      ...
      return this.data.set({
        ...
        activity: this.clientArray(this.stateCtx, this.activity, (function(_this) {
          return function(entry, onRemove, ctx) {
            var arg, date, i, images, num, numberForPreview, pertainingObject, product, text, user, userString, _i;
    ...
    CollaborateView.prototype.initAsync = function(args, done) {
      var init;
      this.args = args;
