...
define(['View', 'Site', 'Formatter', 'util', 'underscore', 'taxonomy'], function(View, Site, Formatter, util, _, taxonomy) {
  ...
  return ItemView = (function(superClass) {
    ...
    ItemView.prototype.initAsync = function(args, done) {
      ...
      this.element = this.agora.modelManager.getModel(this.args.elementType).withId(this.args.elementId, false);
      if (this.element) {
        this.additionalData = {};
    ...
    ItemView.prototype.initItem = function(cb) {
      ...
      if (this.obj || this.itemType) {
        if (this.descriptor && (!this.obj || this.obj.isNull())) {
          ...
          type = (ref = this.itemType) != null ? ref : this.obj.model.name === 'ProductVariant' ? 'Product' : this.obj.model.name;
    ...
    ItemView.prototype.hasMethod = function(name) {
      var ref, ref1;
      return this.methods[name] || ((ref = this.item) != null ? (ref1 = ref.methods) != null ? ref1[name] : void 0 : void 0);
    };
