    ...
    ShareView.prototype.initAsync = function(args, done) {
      ...
      getObject = (function(_this) {
        return function(tableName, id) {
          var table, _ref, _ref1, _ref2;
          table = _this.agora.db.table(tableName);
          id = (_ref = (_ref1 = _this.agora.db.globalToLocalMapping) != null ? (_ref2 = _ref1[tableName]) != null ? _ref2[id] : void 0 : void 0) != null ? _ref : id;
          return table.byId(id);
        };
      })(this);
      init = (function(_this) {
        return function() {
          var belt, decision, id, message, table, title, _ref;
          _this.entries = _this.clientValue();
          title = '';
          if (_this.object === '/') {

          } else {
            _ref = _this.object.split('.'), table = _ref[0], id = _ref[1];
            if (table === 'decisions') {
