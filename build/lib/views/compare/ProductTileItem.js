      ...
      updateProperties = (function(_this) {
        return function() {
          ...
          return Product.siteProduct(product, function(siteProduct) {
            var cv, displayOptions, i, len, properties, property, ref, ref1;
            properties = [];
            _this.propertiesCtx.clear();
            displayOptions = (ref = _this.view.compareView.displayOptions.get()) != null ? ref : {
              displayComponents: []
            };
            ref1 = displayOptions.displayComponents;
