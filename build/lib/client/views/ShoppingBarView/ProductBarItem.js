  ...
  return {
    ...
    c: function() {
      ...
      return ProductBarItem = (function(superClass) {
        ...
        ProductBarItem.prototype.onData = function(data1, barItemViewData) {
          var data, lastEmotion, updateForLastFeeling;
          this.data = data1;
          this.barItemViewData = barItemViewData;
          this.view.withData(this.data.image, (function(_this) {
          ...
          if (1) {
            ...
            this.el.find('a').attr('href', this.data.url);
          }
          this.el.html(this.data.productSid);
          ...
          this.view.withData(this.data.status, (function(_this) {
