  ...
  return {
    ...
    c: function() {
      ...
      return BarItem = (function() {
        function BarItem(view, args) {
          this.view = view;
          this.args = args != null ? args : {};
          this.el = view.el;
          this.elementType = view.elementType;
        }
        ...
        BarItem.prototype.widthChanged = function() {
          var _base;
          return typeof (_base = this.view.parent).childWidthChanged === "function" ? _base.childWidthChanged(this.view) : void 0;
        };
        ...
        BarItem.prototype.init = function(data) {
          var draggingData, orgDraggingData, _ref, _ref1;
          ...
          if ('draggingData' in this.args) {
            if (this.args.draggingData) {
              draggingData = (_ref = typeof this.draggingData === "function" ? this.draggingData() : void 0) != null ? _ref : {};
              _.extend(draggingData, this.args.draggingData);
              util.initDragging(this.el, draggingData);
            }
          } else {
            draggingData = (_ref1 = typeof this.draggingData === "function" ? this.draggingData() : void 0) != null ? _ref1 : {};
          }
