  ...
  return {
    d: (function() {
      ...
      for (_i = 0, _len = widgets.length; _i < _len; _i++) {
        widget = widgets[_i];
        _results.push("widgets/" + widget + "Widget");
      }
      return _results;
    })(),
    c: function() {
      ...
      return ProductPreviewView = (function(_super) {
        ...
        ProductPreviewView.prototype.updateImages = function() {
          ...
          _ref = this.images[this.currentStyle];
          _fn = (function(_this) {
            return function(i) {
          ...
          if (data.images) {
            ...
            withData(data.images, (function(_this) {
              return function(images) {
                var styleImages, styleName, _fn, _ref;
                if ((images != null ? images.images : void 0) && _.keys(images.images).length) {
                  ...
                  if (_.keys(images.images).length === 1) {
                    ...
                    for (styleName in _ref) {
                      styleImages = _ref[styleName];
                      _fn(styleName);
                    }
          ...
          if (data.widgets) {
            return withData(data.widgets, (function(_this) {
              return function(widgets) {
                var widgetData, widgetEl, _i, _len;
...
//# sourceMappingURL=ProductPreviewView.map
