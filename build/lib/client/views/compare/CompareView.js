    ...
    c: function() {
      ...
      return CompareView = (function(superClass) {
        ...
        CompareView.prototype.setContEl = function(contEl) {
          this.contEl = contEl;
          this.contEl.resize((function(_this) {
            return function() {
        ...
        CompareView.prototype.initBreadcrumbs = function(breadcrumbs) {
          var breadcrumb, breadcrumbsEl, i, len, results;
        ...
        CompareView.prototype.configure = function(data) {
          ...
          if (data.state === 'Decision') {
            ...
            updateIcon = (function(_this) {
              return function() {
                var ref;
                icons.setIcon(_this.titleEl.find('.icon'), (ref = data.icon.get()) != null ? ref : 'list', {
                  size: 'small',
                  color: 'white'
                });
