      ...
      return ShoppingBarView = (function(superClass) {
        ...
        ShoppingBarView.prototype.resumeShrink = function() {
          return this.shrinkTimerId = setTimeout(((function(_this) {
            return function() {
              var i, len, listBarItem, ref;
              ref = _this.shrinkQueue;
              for (i = 0, len = ref.length; i < len; i++) {
                listBarItem = ref[i];
        ...
        ShoppingBarView.prototype.mouseEnteredBarItemView = function(barItemView) {
          var deepest, deepestDepth, depth, i, item, j, len, len1, ref, ref1;
        ...
        ShoppingBarView.prototype.mouseLeftBarItemView = function(barItemView) {
          var deepest, deepestDepth, depth, i, item, len, ref;
        ...
        ShoppingBarView.prototype.startEdit = function() {
          ...
          if (!this.editing) {
            this.editing = true;
            ref = this.editListeners;
            results = [];
            for (i = 0, len = ref.length; i < len; i++) {
              listener = ref[i];
              results.push(listener.startEdit());
            }
            return results;
          }
        };
        ...
        ShoppingBarView.prototype.stopEdit = function() {
          ...
          if (this.editing) {
            ...
            for (i = 0, len = ref.length; i < len; i++) {
              listener = ref[i];
              results.push(listener.stopEdit());
            }
            return results;
          }
        };
