      ...
      return CollaborateView = (function(superClass) {
        ...
        CollaborateView.prototype.configure = function(data) {
          ...
          return this.stateView.listInterface(this.el.find('ul.activity'), '.entry', (function(_this) {
            return function(el, data, pos, onRemove) {
              var classesForLength, comp, fn, i, image, imageEl, j, len, len1, objEl, ref, ref1, textEl, view;
              view = _this.stateView.createView();
              onRemove(function() {
                return view.destruct();
              });
                      ...
                      (function(comp, objEl) {
                        ...
                        popup = util.popupTrigger2(objEl, {
                          ...
                          onClose: function(el) {
                            ...
                            return (ref2 = el.data('frame')) != null ? typeof ref2.close === "function" ? ref2.close(100) : void 0 : void 0;
                          }
                        });
