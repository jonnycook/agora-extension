  ...
  return {
    ...
    c: function() {
      ...
      return ChatView = (function(_super) {
        ...
        ChatView.prototype.onData = function(data) {
          var iface;
          this.data = data;
          this.withData(data.online, (function(_this) {
          ...
          this.withData(data.newUnreadMessages, (function(_this) {
          ...
          return iface.setDataSource(data.messages);
        };
