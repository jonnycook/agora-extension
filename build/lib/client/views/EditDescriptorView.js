...
define(function() {
  return {
    ...
    c: function() {
      ...
      return EditDescriptorView = (function(_super) {
        __extends(EditDescriptorView, _super);
        ...
        EditDescriptorView.prototype.onData = function(data) {
          ...
          update = (function(_this) {
            return function() {
              ...
              descriptor = _this.descriptor = (_ref = data.get()) != null ? _ref : {};
              ...
              _this.el.find('[name="product"]').val((_ref1 = (_ref2 = descriptor.product) != null ? _ref2.type : void 0) != null ? _ref1 : '');
              _this.el.find('[name="purpose"]').val((_ref3 = descriptor.purpose) != null ? _ref3 : '');
              _this.el.find('[name="context"]').val((_ref4 = descriptor.context) != null ? _ref4 : '');
              if ((_ref5 = descriptor.product) != null ? _ref5.properties : void 0) {
                _this.el.find('[name="properties"]').val(descriptor.product.properties.join(', '));
              } else {
                _this.el.find('[name="properties"]').val('');
              }
              _this.el.find('[name="recipient"]').val((_ref6 = (_ref7 = descriptor.person) != null ? _ref7.name : void 0) != null ? _ref6 : '');
              _this.el.find('[name="recipient.relationship"]').val((_ref8 = (_ref9 = descriptor.person) != null ? _ref9.relationship : void 0) != null ? _ref8 : '');
              _this.el.find('[name="recipient.age"]').val((_ref10 = (_ref11 = descriptor.person) != null ? _ref11.age : void 0) != null ? _ref10 : '');
              if ((_ref12 = descriptor.person) != null ? _ref12.sex : void 0) {
                _this.el.find('[name="recipient.sex"]').children("[value=" + ((_ref13 = descriptor.person) != null ? _ref13.sex : void 0) + "]").prop('selected', true);
              } else {
...
//# sourceMappingURL=EditDescriptorView.map
