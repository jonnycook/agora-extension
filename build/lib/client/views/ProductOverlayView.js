    ...
    c: function() {
      ...
      return ProductOverlayView = (function(superClass) {
        ...
        function ProductOverlayView(contentScript, productData, imgEl, opts) {
          var attachEl, badgeEl, cancelHide, count, down, el, extraOverlayElements, frameEl, hide, hideTimer, hovering, i, initiateHide, j, len, offsetParentEl, parent, parents, popup, position, positionEl, positionStyle, productPreviewView, show, up, updatePosition;
          if (opts == null) {
            opts = {};
          }
          ...
          if (extraOverlayElements) {
            for (j = 0, len = extraOverlayElements.length; j < len; j++) {
              el = extraOverlayElements[j];
