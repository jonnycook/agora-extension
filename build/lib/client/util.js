      ...
      return util = {
        ...
        initDragging: function(baseEl, args) {
          ...
          return Q(baseEl).bind('mousedown.dragging', function(e) {
            ...
            if (typeof args.cancel === "function" ? args.cancel(this) : void 0) {
              return;
            }
            selector = '[dragarea]';
            dragging = {
              startDrag: function(e) {
                var base, base1, draggingCont, draggingContEl, el, helper, offset, overlay, rootEl, states;
                this.started = true;
                draggingContEl = null;
                ...
                if (typeof (base = this.el.data('dragging')).start === "function") {
                  base.start(e, {
                    helper: this.el,
                    args: args
                  });
                ...
                this.mousemove = function(e) {
                  ...
                  if (this.state && this.state.mousemove(e, left, top) === false) {
                    ...
                    if (typeof (base1 = el.data('dragging')).onGlobal === "function") {
                      base1.onGlobal();
                    }
                ...
                this.mouseup = function(e) {
                  ...
                  if ((ref = this.state) != null) {
                    if (typeof ref.mouseup === "function") {
                      ref.mouseup(e);
                    }
                  }
                  if (overlay != null) {
                ...
                states = {
                  list: (function() {
                    var containerEl, contentEl, count, currentIndex, direction, elementAtIndex, elements, i, indexForSegment, j, posForIndex, ref, ref1, ref2, removed, startIndex, updatePos;
                    containerEl = el.parents('.element').first();
                    if (containerEl.length === 0) {
                      containerEl = rootEl;
                    }
                    contentEl = (ref = (ref1 = containerEl.data('dragging')) != null ? ref1.contentEl : void 0) != null ? ref : containerEl;
                    elements = contentEl.children('.element');
                    removed = false;
                    direction = 'ltr';
                    for (i = j = 0, ref2 = elements.length; 0 <= ref2 ? j < ref2 : j > ref2; i = 0 <= ref2 ? ++j : --j) {
                    ...
                    indexForSegment = function(start, end) {
                      var k, ref3, width, x;
                      x = 0;
                      for (i = k = 0, ref3 = count; 0 <= ref3 ? k < ref3 : k > ref3; i = 0 <= ref3 ? ++k : --k) {
                    ...
                    return {
                      mousemove: function(e, left, top) {
                        var index, k, lock, prevCurrent, ref3, right;
                        lock = false;
                        if (!lock && (e.pageY - el.offsetParent().offset().top < -35 || e.pageX - (contentEl.offset().left + contentEl.width()) > 100 || contentEl.offset().left - e.pageX > 100)) {
                          if (currentIndex !== null) {
                            removed = true;
                            for (i = k = 0, ref3 = count - 1; 0 <= ref3 ? k < ref3 : k > ref3; i = 0 <= ref3 ? ++k : --k) {
                      ...
                      mouseup: function(e) {
                        var base1, k, ref3, ref4;
                        for (i = k = 0, ref3 = count; 0 <= ref3 ? k < ref3 : k > ref3; i = 0 <= ref3 ? ++k : --k) {
                          updatePos(elementAtIndex(i), i);
                        }
                        if ((ref4 = containerEl.data('dragging')) != null) {
                          if (typeof ref4.onReorder === "function") {
                            ref4.onReorder(el, startIndex, currentIndex);
                          }
                        }
                        el.removeClass('activeDrag');
                        return typeof (base1 = el.data('dragging')).stop === "function" ? base1.stop(e) : void 0;
                      }
                    };
                  })(),
                  global: (function() {
                    ...
                    rootEls.sort(function(a, b) {
                      var ref, ref1;
                      return ((ref = $(b).data('dragging').rootZIndex) != null ? ref : 0) - ((ref1 = $(a).data('dragging').rootZIndex) != null ? ref1 : 0);
                    });
                    activeEl = null;
                    dropAction = 'default';
                    ...
                    highlightEl = function(el) {
                      var ref;
                      if ((ref = el.data('dragging')) != null ? ref.highlightEl : void 0) {
                    ...
                    setActiveEl = function(el) {
                      var base1, base2, curEl, data, dragOutList, dragOverList, els, i, j, k, l, len, len1, ref, ref1, ref2, results;
                      ...
                      if (activeEl) {
                        ...
                        if ((ref = activeEl.data('dragging')) != null) {
                          if (typeof ref.onInactive === "function") {
                            ref.onInactive();
                          }
                        }
                      }
                      ...
                      if (dragging.el.data('dragging')) {
                        if (typeof (base1 = dragging.el.data('dragging')).onDraggedOver === "function") {
                          base1.onDraggedOver(activeEl, dragging.el);
                        }
                      }
                      if (activeEl) {
                        if (typeof (base2 = activeEl.data('dragging')).onActive === "function") {
                          base2.onActive();
                        }
                        els = [];
                        ...
                        for (i = j = ref1 = els.length - 1; ref1 <= 0 ? j <= 0 : j >= 0; i = ref1 <= 0 ? ++j : --j) {
                          curEl = $(els[i]);
                          dragOverList.push(curEl.data('dragging'));
                          if (((ref2 = curEl.data('dragging')) != null ? ref2.immutableContents : void 0) && !dragging.el.data('dragging').breaksImmutability) {
                            break;
                          }
                        }
                        highlightEl(activeEl).addClass('activeDrop');
                      }
                      for (k = 0, len = dragOutList.length; k < len; k++) {
                        data = dragOutList[k];
                      ...
                      results = [];
                      for (l = 0, len1 = dragOverList.length; l < len1; l++) {
                        data = dragOverList[l];
                        if (!_.contains(dragOutList, data)) {
                          results.push(typeof data.onDragOver === "function" ? data.onDragOver() : void 0);
                        } else {
                          results.push(void 0);
                        }
                      }
                    ...
                    deeper = function(e) {
                      var childEl, childOffset, children, i, j, ref, ref1, sel;
                      sel = selector;
                      if (activeEl.data('dragging').immutableContents && !dragging.el.data('dragging').breaksImmutability) {
                        sel += '[breaksimmutability]';
                      }
                      children = ((ref = activeEl.data('dragging').contentEl) != null ? ref : activeEl).children(sel);
                      if (children.length > 0) {
                        for (i = j = 0, ref1 = children.length - 1; 0 <= ref1 ? j <= ref1 : j >= ref1; i = 0 <= ref1 ? ++j : --j) {
                    ...
                    drill = function(e, el) {
                      ...
                      children = ((ref = el.data('dragging').contentEl) != null ? ref : el).children(sel);
                      if (children.length > 0) {
                        for (i = j = 0, ref1 = children.length - 1; 0 <= ref1 ? j <= ref1 : j >= ref1; i = 0 <= ref1 ? ++j : --j) {
                          if (el.get(0) === children.get(i)) {
                            continue;
                    ...
                    shallower = function(e) {
                      var contOffset, parentEl, results;
                      ...
                      while (!(e.pageX > contOffset.left && e.pageY > contOffset.top && e.pageX < contOffset.left + activeEl.outerWidth() && e.pageY < contOffset.top + activeEl.outerHeight())) {
                        ...
                        if (parentEl.length) {
                          ...
                          results.push(contOffset = activeEl.offset());
                        } else {
                          setActiveEl(null);
                          break;
                        }
                    ...
                    return {
                      ...
                      start: function() {
                        var base1, id, listener, ref, results;
                        setActiveEl(null);
                        if (args.context !== 'page' && !dragging.fromEl) {
                          dragging.fromEl = baseEl.parents(selector).first();
                        }
                        ref = util.draggingListeners;
                        results = [];
                        for (id in ref) {
                          listener = ref[id];
                          results.push(typeof (base1 = listener.args).onUserStartDrag === "function" ? base1.onUserStartDrag() : void 0);
                        }
                        return results;
                      },
                      mousemove: function(e, left, top) {
                        var contOffset, contentEl, frameEl, hoverEl, j, k, len, len1, ref, ref1, results;
                        ...
                        hoverEl = null;
                        for (j = 0, len = rootEls.length; j < len; j++) {
                          rootEl = rootEls[j];
                          contentEl = $(rootEl);
                        ...
                        if (activeEl) {
                          bundleActionTimer = setTimeout((function() {
                            var base1;
                            return typeof (base1 = activeEl.data('dragging')).onHoldOver === "function" ? base1.onHoldOver(el) : void 0;
                          }), (ref = activeEl.data('dragging').holdDelay) != null ? ref : 500);
                        }
                        return;
                        if (activeEl) {
                          ...
                          if (!(e.pageX > contOffset.left && e.pageY > contOffset.top && e.pageX < contOffset.left + frameEl.outerWidth() && e.pageY < contOffset.top + frameEl.outerHeight())) {
                            ...
                            return bundleActionTimer = setTimeout((function() {
                              var base1;
                              return typeof (base1 = activeEl.data('dragging')).onHoldOver === "function" ? base1.onHoldOver(el) : void 0;
                            }), (ref1 = activeEl.data('dragging').holdDelay) != null ? ref1 : 500);
                          }
                        } else {
                          results = [];
                          for (k = 0, len1 = rootEls.length; k < len1; k++) {
                            rootEl = rootEls[k];
                            contentEl = $(rootEl);
                            contOffset = contentEl.offset();
                            if (e.pageX > contOffset.left && e.pageY > contOffset.top && e.pageX < contOffset.left + contentEl.outerWidth() && e.pageY < contOffset.top + contentEl.outerHeight()) {
                      ...
                      mouseup: function(e) {
                        var base1, base2, base3, id, listener, receivingEl, ref, ref1, ref2;
                        if (bundleActionTimer) {
                          clearTimeout(bundleActionTimer);
                        }
                        ref = util.draggingListeners;
                        for (id in ref) {
                          listener = ref[id];
                          if (typeof (base1 = listener.args).onUserEndDrag === "function") {
                            base1.onUserEndDrag();
                          }
                        }
                        receivingEl = null;
                        ...
                        if (typeof (base2 = el.data('dragging')).stop === "function") {
                          base2.stop(e, {
                            helper: dragging.el,
                            receivingEl: receivingEl
                          });
                        }
                        if (typeof (base3 = el.data('dragging')).onDropped === "function") {
                          base3.onDropped(receivingEl);
                        }
                        if (receivingEl) {
                          if ((ref1 = receivingEl.data('dragging')) != null) {
                            if (typeof ref1.onDroppedOn === "function") {
                              ref1.onDroppedOn(el, dragging.fromEl, dropAction);
                            }
                          }
                        } else if (dragging.fromEl) {
                          if (((ref2 = dragging.fromEl.data('dragging')) != null ? typeof ref2.onRemove === "function" ? ref2.onRemove(el) : void 0 : void 0) !== false) {
                            el.remove();
                          }
                        }
                ...
                if (typeof (base1 = this.state).start === "function") {
                  base1.start();
                }
            ...
            dragging.el = (function() {
              ...
              if (args.context !== 'page') {
                ...
                el = baseEl;
                for (i = j = ref = parents.length - 1; ref <= 0 ? j <= 0 : j >= 0; i = ref <= 0 ? ++j : --j) {
                  curEl = $(parents.get(i));
                  if ((ref1 = curEl.data('dragging')) != null ? ref1.immutableContents : void 0) {
        ...
        isMutable: function(el) {
          var curEl, i, j, parents, ref, ref1;
        ...
        popupTrigger2: function(el, args) {
          ...
          initiateClose = function() {
            ...
            if (pinned) {
              ...
              clearTimeout(timerId);
              if (open) {
                return timerId = setTimeout(close, (ref = args.closeDelay) != null ? ref : 500);
              }
            }
          };
        ...
        styleSelect: function(selectEl, opts) {
          var autoSize, el, hasLabel, ref, ref1, sizeCalcEl, updateLabel, width;
          if (opts == null) {
            opts = {};
          }
          autoSize = (ref = opts.autoSize) != null ? ref : true;
          hasLabel = (ref1 = opts.label) != null ? ref1 : true;
        ...
        tooltip2: function(el, text, opts) {
          ...
          el.bind('mouseenter.tooltip', function() {
            ...
            if (!frame) {
              shouldOpen = true;
              return timerId = setTimeout((function() {
                var contentEl, onClose, ref, ref1, view;
                ...
                frame = Frame.frameAround((ref = opts.anchor) != null ? ref : el, contentEl, _.extend(_.clone(opts), {
                  type: (ref1 = opts.frameType) != null ? ref1 : 'tooltip',
                  onClose: onClose
                }));
                if (opts["class"]) {
        ...
        resolveDraggingData: function(el, cb) {
          ...
          if (el.data('dragging').data) {
            ...
            el.data('view').events.onRepresent.subscribe(function() {
              return cb({
                view: el.data('view').id
              });
            });
          ...
          init = function(el, remove) {
            ...
            updateSide = function() {
              ...
              switch (side) {
                case 'left':
                  el.css({
                    right: anchorEl.outerWidth() + 3 + ((ref = opts.distance) != null ? ref : 0)
                  });
                  return connectorEl.css({
                    marginLeft: -((ref1 = opts.distance) != null ? ref1 : 0)
                  });
                case 'right':
                  el.css({
                    left: anchorEl.outerWidth() + 3 + ((ref2 = opts.distance) != null ? ref2 : 0)
                  });
                  return connectorEl.css({
                    marginRight: -((ref3 = opts.distance) != null ? ref3 : 0)
                  });
              }
            };
            updatePos = function() {
        ...
        decisionPreview: function(args) {
          ...
          updateTooltip = (function(_this) {
            return function() {
              var ref, ref1, text;
              text = ((ref = args.descriptor.get()) != null ? ref.descriptor : void 0) ? (ref1 = args.descriptor.get()) != null ? ref1.descriptor : void 0 : '<i>Edit Decision</i>';
              return util.tooltip2(args.anchorEl(), "<span class='descriptorTooltip'> <span class='preview'><span class='image' /></span> <div class='descriptorWrapper'><span class='icon' /> <span class='descriptor'>" + text + "</span><a class='edit' href='#' /></div> </span>", {
                ...
                init: function(el, close, view) {
                  var classesForLength, contents, edit, openCompareView, prevLength, ref2, updateForLength;
                  args.view.shoppingBarView.propOpen(view);
                  args.view.shoppingBarView.disableProductPopups = true;
                  icons.setIcon(el.find('.icon'), (ref2 = args.icon.get()) != null ? ref2 : 'list', {
                    size: 'small'
                  });
