...
define(function() {
  return function() {
    ...
    return TutorialDialog = (function() {
      function TutorialDialog(steps1, step1) {
        var i, j, ref;
        this.steps = steps1;
        this.step = step1;
      ...
      TutorialDialog.prototype.show = function(anchorEl, orientation, content, cb) {
        var adjust, anchorHeight, anchorPos, anchorWidth, audioUrl, calcFramePos, factor, framePos, frameSize, next, playAudio, pointer, pointerAngle, pointerPos, ref, transitionAngle, updateSteps;
        if (cb == null) {
          cb = null;
        }
        ...
        if ('top' in anchorEl && 'left' in anchorEl) {
          ...
          pointer = (ref = anchorEl.pointer) != null ? ref : true;
        } else {
