    ...
    c: function() {
      return {
        get: function(type, opts) {
          var component, components, file, has2x, i, map, name, position, size, sizes, systems, _i, _len, _ref;
          if (opts == null) {
            opts = {};
          }
          systems = {
          ...
          size = (_ref = sizes[type]) != null ? _ref : {
            width: 48,
            height: 48
          };
          if (opts.size === 'small') {
        ...
        setIcon: function(el, type, opts) {
          ...
          if (!type) {
            ...
            if ((_ref = opts.itemClass) != null ? _ref : true) {
              el.addClass('t-item');
            }
            if (opts.inverted) {
