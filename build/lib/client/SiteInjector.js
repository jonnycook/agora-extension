    ...
    c: function() {
      ...
      ChangeCapsule = function() {
        ...
        func = function() {
          ...
          return obj = {
            ...
            delegate: function() {
              var args;
              args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
              addChange.apply(null, ['$.delegate', jq].concat(__slice.call(args)));
            ...
            bind: function() {
              var args;
              args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
              addChange.apply(null, ['$.bind', jq].concat(__slice.call(args)));
        ...
        _.extend(func, {
          ...
          undo: function() {
            var args, i, type, _i, _ref, _ref1, _results;
            _results = [];
            for (i = _i = _ref = changes.length - 1; _ref <= 0 ? _i <= 0 : _i >= 0; i = _ref <= 0 ? ++_i : --_i) {
              _ref1 = changes[i], type = _ref1.type, args = _ref1.args;
              switch (type) {
                case 'setTimeout':
                  _results.push(clearTimeout(args[0]));
                  break;
                case 'setInterval':
                  _results.push(clearInterval(args[0]));
                  break;
                case '$.addClass':
                  _results.push(args[0].removeClass(args[1]));
                  break;
                case '$.attr':
                  _results.push(args[0].removeAttr(args[1]));
                  break;
                case '$.data':
                  _results.push(args[0].data(args[1], null));
                  break;
                case '$.append':
                  _results.push($(args[1]).remove());
                  break;
                case '$.appendTo':
                  _results.push(args[0].remove());
                  break;
                case '$.load':
                  _results.push(args[0].unbind('load', args[1]));
                  break;
                case '$.blur':
                  _results.push(args[0].unbind('blur', args[1]));
                  break;
                case '$.focus':
                  _results.push(args[0].unbind('focus', args[1]));
                  break;
                case '$.delegate':
                  _results.push(args[0].undelegate(args[1], args[2], args[3]));
                  break;
                case '$.bind':
                  _results.push(args[0].unbind(args[1], args[2]));
                  break;
                case '$.hide':
                  _results.push(args[0].show());
                  break;
                case '$.disableSelection':
                  _results.push(args[0].enableSelection());
                  break;
                case '$.mouseenter':
                  _results.push(args[0].unbind('mouseenter', args[1]));
                  break;
                case '$.mouseleave':
                  _results.push(args[0].unbind('mouseleave', args[1]));
                  break;
                default:
      ...
      return SiteInjector = (function() {
        ...
        function SiteInjector(contentScript, continueTutorial, siteName) {
        ...
        SiteInjector.prototype.removeOverlay = function(attachEl) {
          var _ref;
          if ((_ref = attachEl.data('overlay')) != null) {
            if (typeof _ref.destruct === "function") {
              _ref.destruct();
            }
          }
        ...
        SiteInjector.prototype.attachOverlay = function(opts) {
          ...
          productOverlay = new ProductOverlayView(contentScript, opts.productData, null, {
            ...
            position: (_ref = opts.position) != null ? _ref : 'topRight'
          });
        ...
        SiteInjector.prototype.products = function(selector, productData, opts) {
          var a, config, contentScript, el, productOverlay, variant, _ref;
          if (opts == null) {
            opts = {};
          }
          variant = null;
          ...
          if (opts.overlay && (config != null ? config.productBadges : void 0) !== false) {
            ...
            if (a.length === 0 || !a.attr('agora')) {
              ...
              productOverlay = new ProductOverlayView(contentScript, _.clone(productData), el.get(0), {
                ...
                position: (_ref = opts.overlayPosition) != null ? _ref : 'topRight'
              });
              if (opts.overlayZIndex != null) {
                productOverlay.el.css('zIndex', opts.overlayZIndex);
              }
...
//# sourceMappingURL=SiteInjector.map
