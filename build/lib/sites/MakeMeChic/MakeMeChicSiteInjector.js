...
define(function() {
  return {
    ...
    c: function() {
      ...
      return MakeMeChicSiteInjector = (function(superClass) {
        extend(MakeMeChicSiteInjector, superClass);
        ...
        MakeMeChicSiteInjector.prototype.productListing = {
          ...
          productSid: function(href, a, img) {
            var name, ref;
            name = (ref = href.match(/([^\/]*?)\.html$/)) != null ? ref[1] : void 0;
            return name;
          }
        };
...
//# sourceMappingURL=MakeMeChicSiteInjector.js.map
