...
define(['scraping/SiteProduct', 'util'], function(SiteProduct, util) {
  var JCrewProduct;
  return JCrewProduct = (function(superClass) {
    extend(JCrewProduct, superClass);
    ...
    JCrewProduct.prototype.variantImage = function(variant, cb) {
      return this.product["with"]('more', (function(_this) {
        return function(more) {
          var ref;
          if (more) {
            return cb((ref = more.colorImages) != null ? ref[variant.Color] : void 0);
          } else {
            return cb();
          }
        };
...
//# sourceMappingURL=JCrewProduct.js.map
