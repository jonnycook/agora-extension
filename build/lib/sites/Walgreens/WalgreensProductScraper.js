...
define(['scraping/ProductScraper', 'scraping/resourceScrapers/PatternResourceScraper', 'scraping/resourceScrapers/ScriptedResourceScraper', 'scraping/resourceScrapers/JsonResourceScraper', 'underscore'], function(ProductScraper, PatternResourceScraper, ScriptedResourceScraper, JsonResourceScraper, _) {
  ...
  return WalgreensProductScraper = (function(_super) {
    __extends(WalgreensProductScraper, _super);
    ...
    WalgreensProductScraper.prototype.properties = {
        ...
        scraper: ScriptedResourceScraper(function() {
          ...
          this.execBlock(function() {
            this.get(ratUrl, function(response) {
              var entry, isReview, rating, revHash, reviews, _i, _len;
      ...
      more: {
        resource: 'productPage',
        scraper: ScriptedResourceScraper(function() {
          var altDescCheck, altDescUrl, author, authorBio, authorMatches, authorNames, bioMatch, bioMatches, content, count, desc, description, editorialReviews, erMatches, from, image, imageMatches, images, ingredients, isbn, item, match, matches, name, overview, par, switches, uses, value, warnings, _i, _j, _k, _l, _len, _len1, _len2, _len3;
          switches = {
            images: true,
            overview: true,
            description: true,
          ...
          if (switches.author) {
            ...
            count = 0;
            for (_i = 0, _len = authorMatches.length; _i < _len; _i++) {
              item = authorMatches[_i];
              if (count > 0) {
            ...
            for (_j = 0, _len1 = bioMatches.length; _j < _len1; _j++) {
              match = bioMatches[_j];
...
//# sourceMappingURL=WalgreensProductScraper.map
