...
define(function() {
  return {
    ...
    c: function() {
      ...
      return TutorialSiteInjector = (function(superClass) {
        extend(TutorialSiteInjector, superClass);
        ...
        TutorialSiteInjector.prototype.run = function() {
          return this.initPage((function(_this) {
            return function() {
              var __, callWhen, doTutorial, done, el, j, len, productSid, ref, ref1, shoppingBarView, siteName, startTutorial, stepStartTime, tutorial, tutorialStep, tutorialSteps, tutorialStepsText;
              ...
              ref = $('#products .product[data-product]');
              for (j = 0, len = ref.length; j < len; j++) {
                el = ref[j];
                ref1 = /([^\/]*)\/(.*)/.exec($(el).attr('data-product')), __ = ref1[0], siteName = ref1[1], productSid = ref1[2];
...
//# sourceMappingURL=TutorialSiteInjector.js.map
