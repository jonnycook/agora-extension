...
define(['scraping/SiteProduct', 'underscore'], function(SiteProduct, _) {
  var QVCProduct;
  return QVCProduct = (function(superClass) {
    extend(QVCProduct, superClass);

    function QVCProduct() {
      return QVCProduct.__super__.constructor.apply(this, arguments);
    }

    QVCProduct.prototype.images = function(cb) {
...
//# sourceMappingURL=QVCProduct.js.map
