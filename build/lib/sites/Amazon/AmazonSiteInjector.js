...
define(function() {
  return {
    ...
    c: function() {
      ...
      return AmazonSiteInjector = (function(superClass) {
        extend(AmazonSiteInjector, superClass);
        ...
        AmazonSiteInjector.prototype.onInitPage = function() {
          ...
          window.clearProducts = (function(_this) {
            return function() {
              ...
              ref = $('a img[src^="http://ecx.images-amazon.com/images/I/"]');
              results = [];
              for (j = 0, len = ref.length; j < len; j++) {
                el = ref[j];
                if (matchProductSid($(el).parents('a:first').attr('href'))) {
                  results.push(_this.clearProductEl(el));
                } else {
                  results.push(void 0);
                }
              }
...
//# sourceMappingURL=AmazonSiteInjector.js.map
