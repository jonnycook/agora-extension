...
define(function() {
  return {
    ...
    c: function() {
      ...
      return ModClothSiteInjector = (function(superClass) {
        extend(ModClothSiteInjector, superClass);
        ...
        ModClothSiteInjector.prototype.productListing = {
          ...
          productSid: function(href, a, img) {
            var id, name, ref, ref1;
            if (a.parents('li[data-id]').length) {
              return (a.parents('li[data-id]').attr('data-id')) + ":" + (href.match(/[^\/]*$/)[0]);
            } else {
              if (a.attr('data-analytics-ga')) {
                id = (ref = a.attr('data-analytics-ga').match(/\[%22.*?%22,%22.*?%22,%22\d*:(\d*)/)) != null ? ref[1] : void 0;
                if (id) {
                  name = (ref1 = href.match(/\/-?([^\/]*)$/)) != null ? ref1[1] : void 0;
                  if (name) {
...
//# sourceMappingURL=ModClothSiteInjector.js.map
