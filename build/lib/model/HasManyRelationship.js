...
define(['./ObservableArray', './auxiliary/maintainOrder2', './Relationship', 'util'], function(ObservableArray, maintainOrder, Relationship, util) {
  ...
  ModelInstanceWrapper = (function() {
    function ModelInstanceWrapper(_rel, _joint) {
      ...
      this._update = (function(_this) {
        return function() {
          ...
          if (_this._instance.instanceMethods) {
            ref1 = _this._instance.instanceMethods;
            fn = function(method) {
    ...
    ModelInstanceWrapper.prototype["with"] = function() {
      var ref;
      return (ref = this._instance)["with"].apply(ref, arguments);
    };

    ModelInstanceWrapper.prototype.retrieve = function() {
      var ref;
      return (ref = this._instance).retrieve.apply(ref, arguments);
    };
  ...
  return HasManyRelationship = (function(superClass) {
    extend(HasManyRelationship, superClass);
    ...
    function HasManyRelationship(_instance, _args, _relName) {
      var foreignKey, getModel, initRecord, onRecord, ref, relKey, remove, testRelation, through;
      ...
      ref = this._args, foreignKey = ref.foreignKey, relKey = ref.relKey, through = ref.through;
      this._model = this._args.model;
      getModel = (function(_this) {
        return function(record) {
      ...
      this._list.name = "HasManyRelationship::" + this._model.name + "." + this._relName;
      ...
      remove = (function(_this) {
        return function(record) {
          var i, j, modelName, recordData, ref1, ref2, relId;
          ...
          if (_this._args.orderBy) {
            if (_this.length()) {
              for (i = j = ref1 = Math.min(record.get(_this._args.orderBy), _this.length() - 1), ref2 = _this.length(); ref1 <= ref2 ? j < ref2 : j > ref2; i = ref1 <= ref2 ? ++j : --j) {
      ...
      if (this._args["for"]) {
        this.init = (function(_this) {
          return function() {
            ...
            path = _this._args["for"].path.split('.');
            rel = _this._instance.get(path[0]).get(path[1]);
            _this["for"] = onRelInst = function(relInst) {
              var args, inst;
              inst = _this.find(function(inst) {
                return inst.get(_this._args["for"].key) === relInst.get('id');
              });
              if (!inst) {
                args = {};
                args[_this._args["for"].key] = relInst.get('id');
            ...
            return _this.observeObject(rel, function(mutation) {
              ...
              if (mutation.type === 'insertion') {
                ...
                inst = _this.find(function(inst) {
                  return inst.get(_this._args["for"].key) === mutation.value.get('id');
                });
                if (inst) {
...
//# sourceMappingURL=HasManyRelationship.js.map
