...
define(function() {
  var DevProductScraper;
  return DevProductScraper = (function() {
    function DevProductScraper(site, productSid, background) {
      var properties;
      this.site = site;
    ...
    return DevProductScraper;

  })();
});

//# sourceMappingURL=DevProductScraper.map
