...
window._activity = function() {
  var activity, arg, args, i, object, parent, storeId, type, _i, _len;
  type = arguments[0], object = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
  ...
  object = (function() {
    ...
    switch (object.modelName) {
      ...
      case 'ListElement':
        ...
        return (_ref = agora.modelManager.getModel('Decision').find({
